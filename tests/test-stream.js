...
o.spec("stream", function () {
  o.spec("stream", function () {
    ...
    o("can SKIP", function () {
      ...
      var b = a.map(function (value) {
        return value === 5 ? Stream.SKIP : value;
      });
    ...
    o("HALT is a deprecated alias of SKIP and warns once", function () {
      ...
      try {
        ...
        o(warnings).deepEquals([
          "HALT is deprecated and has been renamed to SKIP",
        ]);
        o(Stream.HALT).equals(Stream.SKIP);
        o(warnings).deepEquals([
          "HALT is deprecated and has been renamed to SKIP",
  ...
  o.spec("combine", function () {
    ...
    o("combines atomically", function () {
      var count = 0;
      var a = Stream();
      var b = Stream.combine(
        function (a) {
          return a() * 2;
        },
        [a]
      );
      var c = Stream.combine(
        function (a) {
          return a() * a();
        },
        [a]
      );
      var d = Stream.combine(
        function (b, c) {
          count++;
          return b() + c();
        },
    ...
    o("combines and maps nested streams atomically", function () {
      ...
      var e = Stream.combine(
        function (x) {
          return x();
        },
        [d]
      );
      var f = Stream.combine(
        function (b, e) {
          count++;
          return b() + e();
        },
    ...
    o(
      "combine lists only changed upstreams in last arg with default value",
      function () {
        var streams = [];
        var a = Stream(3);
        var b = Stream(5);
    ...
    o(
      "combine will throw with a helpful error if given non-stream values",
      function () {
        var spy = o.spy();
        var a = Stream(1);
        var thrown = null;
  ...
  o.spec("lift", function () {
    o("transforms value", function () {
      var stream = Stream();
      var doubled = Stream.lift(function (s) {
        return s * 2;
      }, stream);
    ...
    o("lifts atomically", function () {
      var count = 0;
      var a = Stream();
      var b = Stream.lift(function (a) {
        return a * 2;
      }, a);
      var c = Stream.lift(function (a) {
        return a * a;
      }, a);
      var d = Stream.lift(
        function (b, c) {
    ...
    o(
      "lift will throw with a helpful error if given non-stream values",
      function () {
        var spy = o.spy();
        var a = Stream(1);
        var thrown = null;
  ...
  o.spec("merge", function () {
    o("transforms an array of streams to an array of values", function () {
      var all = Stream.merge([Stream(10), Stream("20"), Stream({ value: 30 })]);
    ...
    o("remains pending until all streams are active", function () {
      ...
      var all = Stream.merge([Stream(10), Stream("20"), straggler]);
  ...
  o.spec("toJSON", function () {
    ...
    o("works w/ JSON.stringify", function () {
      ...
      o(JSON.stringify(Stream([1, 2, 3]))).deepEquals(
        JSON.stringify([1, 2, 3])
      );
      o(JSON.stringify(Stream())).equals(JSON.stringify(undefined));
      o(JSON.stringify(Stream(new Date(0)))).equals(
  ...
  o.spec("map", function () {
    ...
    o("works with pending stream", function () {
      var stream = Stream(undefined);
      var mapped = stream["fantasy-land/map"](function () {
        return Stream();
      });
  ...
  o.spec("ap", function () {
    o("works", function () {
      var apply = Stream(function (value) {
        return value * 2;
      });
      var stream = Stream(3);
  ...
  o.spec("fantasy-land", function () {
    ...
    o.spec("apply", function () {
      o("composition", function () {
        var a = Stream(function (value) {
          return value * 2;
        });
        var u = Stream(function (value) {
          return value * 3;
        });
        var v = Stream(5);

        var mapped = v["fantasy-land/ap"](
          u["fantasy-land/ap"](
            a["fantasy-land/map"](function (f) {
              return function (g) {
                return function (x) {
                  return f(g(x));
                };
    ...
    o.spec("applicative", function () {
      o("identity", function () {
        var a = Stream["fantasy-land/of"](function (value) {
          return value;
        });
        var v = Stream(5);
      ...
      o("homomorphism", function () {
        ...
        o(
          a.constructor["fantasy-land/of"](x)["fantasy-land/ap"](
            a.constructor["fantasy-land/of"](f)
          )()
        ).equals(6);
        o(
          a.constructor["fantasy-land/of"](x)["fantasy-land/ap"](
        ...
        ).equals(a.constructor["fantasy-land/of"](f(x))());
      });
      o("interchange", function () {
        ...
        o(a.constructor["fantasy-land/of"](y)["fantasy-land/ap"](u)()).equals(
          6
        );
        o(a.constructor["fantasy-land/of"](y)["fantasy-land/ap"](u)()).equals(
          u["fantasy-land/ap"](
            a.constructor["fantasy-land/of"](function (f) {
              return f(y);
            })
          )()
        );
